...
const withContext = (Component: ComponentType<TechDocsSearchProps>) => {
  return (props: TechDocsSearchProps) => (
...
const TechDocsSearchBar = withContext((props: TechDocsSearchProps) => {
